...
describe Relationship do
  ...
  let(:relationship) {user_follower.relationships.build(tv_show_id: tv_show_followed.id)}
  ...
  describe "accessible attributes" do
  	it "should not allow access to user_follower id" do
  		expect do
  			Relationship.new(user_id: user_follower.id)
  ...
  describe "when tv_show id is not present" do
  	before { relationship.tv_show_id = nil }
